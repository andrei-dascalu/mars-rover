...
* `php index.php <data_filename>`
* if provided filename doesn't exist, it will use sample.txt
...
2. Send us the solution of the coding challenge in .zip format by email! :)
